...
export const experiencesData = [
  ...
  },
  {
    ...
    company_icon: qbLogo,
    descriptions: [ 
      "Led strategic integration of SonarQube & BlackDuck into Jenkins CI/CD pipeline, reducing critical risk factors by 20%",
      "Engineered an internal tool automating FIX order message creation and transmission, streamlining trading operations",
      "Enhanced FIX messaging platform by integrating support for Multi-Leg orders, boosting operational efficiency by 15%",
      "Designed & optimized data solutions supporting high-performance trading applications, enhancing database efficiency",
      "Developed interactive, high-performance Vue.js web application to visualize complex trading data for internal systems",
      "Provided robust production support and enhanced systems, ensuring high availability for critical trading infrastructure",
    ],
    icon: React.createElement(CgWorkAlt),
