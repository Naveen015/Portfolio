...
export const experiencesData = [
  ...
  },
  {
    ...
    company_icon: qbLogo,
    descriptions: [ 
      "• Optimized data infrastructure with comprehensive Snowflake logging, improving data traceability for 50+ critical tables",
      "• Developed efficient data pipelines with SnowSQL, accelerating data ingestion by 25% through SnowPipe optimization",
      "• Designed & built comprehensive analytical tools, including adv. Power BI reports, dashboards & custom Power Apps",
      "• Implemented adv. data warehousing features, applying dimensional modeling and leveraging Snowflake's time travel",
      "• Utilized Python and Unix scripting to automate 15+ ETL processes, enhancing data flow efficiency and reliability",
      "• Integrated Snowflake with Databricks, AWS EMR, and Power BI, creating a robust and versatile data ecosystem",
    ],
    icon: React.createElement(CgWorkAlt),
  ...
  },
  {
    ...
    descriptions: [ 
      "• Automated large-scale data mining, elevating processing efficiency by 25% for OpenStreetMap visualization",
      "• Devised proprietary map-matching algorithm to model accurately urban traffic flow, aiding efficient city planning",
  ...
  },
  {
    ...
    descriptions: [
      "• Implemented a program to scan vehicle labels leveraging openCV, boosting validation performance system by 3%",
      "• Devised a custom TensorFlow-based object detection model, achieving 99% accuracy in text engraving recognition",
      "• Integrated AI model into manufacturing, automating quality control and reducing manual inspection time by 10%",
    ],
    icon: React.createElement(CgWorkAlt),
